...
import dom.institution.lab.cns.engine.commandline.CommandLineParser;
...
public class ConfigInitializer {
    ...
    private static String validateFileExistsInternal(Properties properties, String key, String filePath, String fileDescription) throws IOException {
        ...
        // Add cns-specific directories
        baseDirs.add(currentDir.resolve("cns"));
        baseDirs.add(currentDir.resolve("cns").resolve("resources"));
        baseDirs.add(currentDir.getParent().resolve("cns"));
        baseDirs.add(currentDir.getParent().resolve("cns").resolve("resources"));
