...
These keys appear in the shipped example but are never read by the engine in this module. They may be historical, consumed only by downstream protocol modules (`cns-bitcoin`, `cns-tangle`), or stale:
